<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MarketingAutomationDesigner.aspx.cs" 
Inherits="Sitecore.Shell.Applications.MarketingAutomation.Designer.MarketingAutomationDesigner" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
  <title>Marketing Automation Designer</title>		
...
<div id="silverlightControlHost" style="height:100%; text-align:center;">
  <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%" id="scSilverlightEngagementPlan">
    <param name="source" value="/sitecore/shell/ClientBin/Sitecore.Shell.MarketingAutomation.Designer.xap"/>
    ...
    <div style="width: 100%; height: 100%;">
        <table cellpadding="0" cellspacing="0" border="0" align="center">
          <tr>
            <td>
              <h2>
                Marketing Automation Designer</h2>
            </td>
          </tr>
          <tr>
            <td align="left">
              <p>
                Marketing Automation Designer requires Microsoft Silverlight 5 to run.<br />
