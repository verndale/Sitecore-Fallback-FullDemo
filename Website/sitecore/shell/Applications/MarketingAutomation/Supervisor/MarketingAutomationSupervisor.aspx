<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MarketingAutomationSupervisor.aspx.cs" Inherits="Sitecore.Shell.Applications.MarketingAutomation.Supervisor.MarketingAutomationSupervisor" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
  <title>Marketing Automation Supervisor</title>
  ...
  <script type="text/javascript" src="/sitecore/shell/Applications/MarketingAutomation/Scripts/Supervisor.js"></script>
</head>
<body>
<form id="form1" runat="server" style="height:100%;">
  <div id="silverlightControlHost" style="height:100%;">
    <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%" id="scSilverlightEngagementPlan">
      <param name="source" value="/sitecore/shell/ClientBin/Sitecore.Shell.MarketingAutomation.Supervisor.xap"/>
