...
<div class="wf-progress" style="padding: 2em 0">
   ...
   <div style="display: none;" id="progressDetailsPanel">
      ...
      <div>
         <asp:LinkButton ID="DownloadLinkButton" Text="Download as file" Style="padding-top: 5px;
            float: right;" Enabled="false" runat="server" OnClick="DownloadInstallationLogClick" />
      </div>
