...
<style type="text/css">
      ...
      .table-wrapper table td.message { white-space: nowrap; width:150px;}
            ...
            <asp:GridView ID="ResultGrid" AllowSorting="True" BorderWidth="0px" runat="server"
               ...
               <Columns>
                  <asp:TemplateField HeaderText="Message Type" SortExpression="Level">
                     <ItemTemplate>
                        <asp:Label ID="MessageType" runat="server" Text='<%# Bind("MessageGroupDescription") %>'></asp:Label>
                     </ItemTemplate>
                     <ItemStyle />
                  </asp:TemplateField>
                  <asp:TemplateField HeaderText="Description" SortExpression="ShortDescription">
                     <ItemTemplate>
                        <asp:Label ID="ShortDescription" CssClass="short-description" ToolTip="Click to show more details" runat="server"></asp:Label><div Style="display: none;"><p style="padding:0;margin:0;">&nbsp</p>
